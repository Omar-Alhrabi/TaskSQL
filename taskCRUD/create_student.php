...
<body>
    <form action="create_student.php" method="post" class="align-items-center">
...
$enrollment_year = $_POST['enrollment_year'];
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO students (student_id, first_name, last_name, email, date_of_birth, gender, major, enrollment_year) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
